...
def test_two_root_layout_integrity():
    ...
    internal_files = ["PRD.md", "ARCHITECTURE.md", "project_manifest.md", "DESIGN_SPEC.md", "SECURITY_AUDIT.md"]
    for f in internal_files:
        assert not (deliverable_root / f).exists(), f"Internal file {f} found in deliverable root!"
